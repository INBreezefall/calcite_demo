...
// 3.parser function
  final public void SelectExpr(String expr) throws ParseException {// 局部变量定义
    int res;
...
// JavaCode
  ...
  final public int Expression() throws ParseException {int res = 0;
    int v;
    // 解析 一个词组 TOKEN 为数值变量
        res = Number();
    label_1:
