/* Generated By:JavaCC: Do not edit this line. SqlLoadExtendParserImplConstants.java */
 ...
 */
public interface SqlLoadExtendParserImplConstants {
  ...
  int LOAD = 685;
  /** RegularExpression Id. */
  int UNSIGNED_INTEGER_LITERAL = 686;
  /** RegularExpression Id. */
  int APPROX_NUMERIC_LITERAL = 687;
  /** RegularExpression Id. */
  int DECIMAL_NUMERIC_LITERAL = 688;
  /** RegularExpression Id. */
  int EXPONENT = 689;
  /** RegularExpression Id. */
  int HEXDIGIT = 690;
  ...
  int WHITESPACE = 691;
  /** RegularExpression Id. */
  int BINARY_STRING_LITERAL = 692;
  /** RegularExpression Id. */
  int QUOTED_STRING = 693;
  /** RegularExpression Id. */
  int PREFIXED_STRING_LITERAL = 694;
  /** RegularExpression Id. */
  int UNICODE_STRING_LITERAL = 695;
  /** RegularExpression Id. */
  int CHARSETNAME = 696;
  /** RegularExpression Id. */
  int BIG_QUERY_DOUBLE_QUOTED_STRING = 697;
  /** RegularExpression Id. */
  int BIG_QUERY_QUOTED_STRING = 698;
  /** RegularExpression Id. */
  int UNICODE_QUOTED_ESCAPE_CHAR = 699;
  /** RegularExpression Id. */
  int LPAREN = 700;
  /** RegularExpression Id. */
  int RPAREN = 701;
  ...
  int SLASH = 725;
  /** RegularExpression Id. */
  int PERCENT_REMAINDER = 726;
  /** RegularExpression Id. */
  int CONCAT = 727;
  /** RegularExpression Id. */
  int NAMED_ARGUMENT_ASSIGNMENT = 728;
  /** RegularExpression Id. */
  int DOUBLE_PERIOD = 729;
  /** RegularExpression Id. */
  int QUOTE = 730;
  /** RegularExpression Id. */
  int DOUBLE_QUOTE = 731;
  /** RegularExpression Id. */
  int VERTICAL_BAR = 732;
  /** RegularExpression Id. */
  int CARET = 733;
  /** RegularExpression Id. */
  int DOLLAR = 734;
  ...
  int COMMENT_END = 741;
  /** RegularExpression Id. */
  int SINGLE_LINE_COMMENT = 744;
  /** RegularExpression Id. */
  int FORMAL_COMMENT = 745;
  /** RegularExpression Id. */
  int MULTI_LINE_COMMENT = 746;
  /** RegularExpression Id. */
  int BRACKET_QUOTED_IDENTIFIER = 748;
  /** RegularExpression Id. */
  int QUOTED_IDENTIFIER = 749;
  /** RegularExpression Id. */
  int BACK_QUOTED_IDENTIFIER = 750;
  /** RegularExpression Id. */
  int BIG_QUERY_BACK_QUOTED_IDENTIFIER = 751;
  /** RegularExpression Id. */
