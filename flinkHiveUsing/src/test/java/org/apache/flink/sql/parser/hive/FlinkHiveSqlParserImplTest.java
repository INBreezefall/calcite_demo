...
class FlinkHiveSqlParserImplTest extends SqlParserTest {
    ...
    @Override public SqlParserFixture fixture() {
        return super.fixture()
                .withTester(new FlinkHiveTesterImpl())
                .withConfig(c -> c.withParserFactory(FlinkHiveSqlParserImpl.FACTORY));
    }

    public static class FlinkHiveTesterImpl extends TesterImpl {
